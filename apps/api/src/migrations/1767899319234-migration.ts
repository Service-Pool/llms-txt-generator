...
export class Migration1767899319234 implements MigrationInterface {
    name = 'Migration1767899319234'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`generations\` ADD CONSTRAINT \`FK_e8fc0ba85a315c9f066c6dd7d14\` FOREIGN KEY (\`calculation_id\`) REFERENCES \`calculations\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
