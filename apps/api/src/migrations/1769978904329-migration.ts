...
export class Migration1769978904329 implements MigrationInterface {
    name = 'Migration1769978904329'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`snapshot_urls\` (\`id\` int NOT NULL AUTO_INCREMENT, \`url\` varchar(512) NOT NULL, \`title\` varchar(255) NOT NULL, \`contentHash\` varchar(64) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), UNIQUE INDEX \`IDX_ea0b45705f39e7cc1738776d5b\` (\`url\`, \`contentHash\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX \`IDX_ea0b45705f39e7cc1738776d5b\` ON \`snapshot_urls\``);
